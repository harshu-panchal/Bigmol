...
import { FiUser, FiMail, FiPhone, FiLock, FiEye, FiEyeOff, FiSave, FiCamera, FiArrowLeft, FiPackage, FiMapPin, FiLogOut, FiChevronRight, FiBell, FiShield } from 'react-icons/fi';
              ...
              {!isDesktop && activeTab === 'menu' && (
                ...
                >
                  ...
                  <div className="glass-card rounded-2xl p-6 flex flex-col items-center text-center shadow-sm">
                    ...
                    {user?.deliveryOtp && (
                      <div className="mt-4 p-3 bg-primary-50 rounded-xl border border-primary-100 w-full">
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-2">
                            <FiShield className="text-primary-600 text-[10px]" />
                            <span className="text-[10px] font-bold text-primary-700 uppercase tracking-wider">Delivery Code</span>
                          </div>
                          <span className="text-lg font-black tracking-widest text-primary-600 font-mono">
                            {user.deliveryOtp}
                          </span>
                        </div>
                      </div>
