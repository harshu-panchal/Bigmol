    ...
    >
      ...
      <div className="p-2 flex-1 flex flex-col">
        ...
        <div className="flex flex-col mb-1 leading-none">
          ...
          {item.isWholesale && (
            <span className="text-[7px] font-black bg-blue-50 text-blue-600 px-1 py-0.5 rounded uppercase tracking-tighter border border-blue-100 mt-0.5 w-fit">Wholesale</span>
          )}
        </div>
