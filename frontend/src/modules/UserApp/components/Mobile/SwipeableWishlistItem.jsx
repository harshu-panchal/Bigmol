    ...
    <motion.div
      ...
      <div className="flex gap-4 relative z-10">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-lg font-bold text-primary-600 mb-3 flex items-center gap-2 flex-wrap">
            {formatPrice(item.price)}
            {item.isWholesale && (
              <span className="px-1.5 py-0.5 bg-blue-50 text-[10px] text-blue-600 font-bold rounded-md border border-blue-100 uppercase tracking-tighter">
                Wholesale
              </span>
            )}
          </p>
