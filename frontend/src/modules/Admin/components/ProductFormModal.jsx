...
const ProductFormModal = ({ isOpen, onClose, productId, onSuccess }) => {
        ...
        if (product) {
          ...
          setFormData({
            ...
            variants: {
              ...
              wholesalePrices: product.variants?.wholesalePrices || {},
  ...
  const syncVariantMaps = (sizes = [], colors = [], variants = {}) => {
    ...
    combinations.forEach(({ key }) => {
      ...
      if (Object.prototype.hasOwnProperty.call(variants?.wholesalePrices || {}, key)) {
        nextWholesalePrices[key] = variants.wholesalePrices[key];
      }
  ...
  const handleSubmit = async (e) => {
    ...
    const submissionData = {
      ...
      minWholesaleQty: formData.minWholesaleQty
        ? parseInt(formData.minWholesaleQty)
        : 10,
